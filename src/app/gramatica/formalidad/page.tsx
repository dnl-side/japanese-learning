      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 pb-24 pt-10 sm:px-6">
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <h1
              className="mt-4 text-[clamp(2.4rem,7vw,4.2rem)] font-bold leading-none"
              style={{ color: "var(--ink)" }}
            >
        ...
        <section className="mt-8 grid gap-5 lg:grid-cols-2">
          {FORMALITY_HUB.modules.map((module, index) => (
            ...
            >
              ...
              <h2 className="mt-4 text-2xl font-bold" style={{ color: "var(--ink)" }}>
                {module.title}
              </h2>
        ...
        <section className="mt-8 rounded-[28px] border p-5 sm:p-6">
          <SectionTitle
            eyebrow="Cómo estudiarlo"
            title="Ruta recomendada para no mezclar conceptos"
            desc="La idea es que el usuario entienda primero el cambio de registro general y después profundice en la capa alta de formalidad."
          />
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {FORMALITY_HUB.studyFlow.map((item) => (
              ...
              >
                ...
                <h3 className="mt-3 text-base font-bold" style={{ color: "var(--ink)" }}>
                  {item.title}
                </h3>
        ...
        <section className="mt-8 rounded-[28px] border p-5 sm:p-6">
          <SectionTitle
            eyebrow="Enfoque del módulo"
            title="Qué entra en cada parte"
            desc="Así evitas repetir contenido y cada página mantiene una función clara dentro del estudio de formalidad."
          />
