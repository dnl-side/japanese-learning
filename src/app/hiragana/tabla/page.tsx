//src/app/hiragana/tabla/page.tsx
...
interface SelectedChar {
  ...
  romaji: string;
  strokeCount: number;
  lesson?: ReturnType<typeof getLessonByChar>;
}
...
const GRADIENT_BASIC = "linear-gradient(135deg, #F48FB1 0%, #CE93D8 100%)";
  ...
  return (
    <motion.button
      ...
      onClick={() =>
        onSelect({
          char,
          romaji: romaji ?? HIRAGANA_ROMAJI[char] ?? "",
          strokeCount: HIRAGANA_STROKE_COUNT[char] ?? 1,
          lesson: getLessonByChar(char),
        })
      }
      ...
      style={{
        minHeight: "clamp(4.25rem, 10vw, 5.4rem)",
        background: gradient,
        borderColor: isSelected ? "rgba(188,0,45,0.45)" : "rgba(255,255,255,0.42)",
        boxShadow: isSelected
          ? "0 0 0 3px rgba(255,255,255,0.95), 0 0 0 5px rgba(188,0,45,0.22), 0 16px 30px rgba(0,0,0,0.16)"
          : "0 10px 22px rgba(192, 99, 140, 0.18)",
    ...
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0) 38%, rgba(255,255,255,0.08) 100%)",
        }}
      />
  ...
  return (
    <section
      ...
      style={{
        ...
        borderColor: "rgba(188,0,45,0.08)",
        boxShadow: "0 20px 40px rgba(64, 41, 66, 0.07)",
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div
          ...
          style={{
            ...
            border: "1px solid rgba(242,167,187,0.18)",
          }}
        >
          <span
    ...
    return (
      <div
        ...
        style={{
          ...
          borderColor: "rgba(188,0,45,0.08)",
          boxShadow: "0 20px 40px rgba(64, 41, 66, 0.08)",
          backdropFilter: "blur(10px)",
        }}
      >
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(244,143,177,0.14) 0%, rgba(206,147,216,0.12) 100%)",
            border: "1px solid rgba(188,0,45,0.08)",
          }}
        >
          <p className="text-xs font-bold uppercase tracking-[0.2em]" style={{ color: "var(--sakura-dark)" }}>
            Panel de detalle
          </p>
          ...
          <p className="mt-2 text-sm leading-6" style={{ color: "var(--ink-soft)", opacity: 0.8 }}>
            Aquí podrás ver la lectura, cantidad de trazos y accesos rápidos para practicar o revisar
            vocabulario.
          </p>
        </div>
        ...
        <div className="space-y-3 text-sm" style={{ color: "var(--ink-soft)" }}>
          <div
            ...
            style={{ borderColor: "rgba(188,0,45,0.08)", background: "rgba(255,255,255,0.66)" }}
          >
            ✏ Práctica directa desde cada carácter
          </div>
          <div
            className="rounded-2xl border p-3"
            style={{ borderColor: "rgba(188,0,45,0.08)", background: "rgba(255,255,255,0.66)" }}
          >
            册 Acceso rápido al vocabulario relacionado
          </div>
        </div>
      </div>
    );
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div
          className="mb-4 rounded-2xl p-4"
          style={{ background: "rgba(242,167,187,0.08)", border: "1px solid rgba(242,167,187,0.22)" }}
        >
          <div className="mb-2 text-xs font-bold uppercase tracking-[0.18em]" style={{ color: "var(--sakura-dark)" }}>
            Trazos
          </div>

          <div className="flex items-center justify-between gap-3">
            <div className="flex gap-1">
              {Array.from({ length: selected.strokeCount }).map((_, index) => (
                <div
                  key={index}
        ...
        {selected.lesson && (
          <div
            className="mb-4 rounded-2xl p-4"
            style={{ border: "1px solid rgba(188,0,45,0.08)", background: "rgba(255,255,255,0.72)" }}
          >
            <div className="text-xs font-bold uppercase tracking-[0.18em]" style={{ color: "var(--sakura-dark)" }}>
              Lección relacionada
            </div>
        ...
        <div className="flex flex-col gap-2">
          <Link
            href={`/hiragana/practica/${encodeURIComponent(selected.char)}`}
            ...
            style={{ background: GRADIENT_BASIC, boxShadow: "0 14px 28px rgba(192, 99, 140, 0.22)" }}
          >
            ✏ Practicar escritura
          </Link>
          ...
          {selected.lesson && (
            <Link
              href={`/hiragana/vocabulario?leccion=${selected.lesson.id}`}
...
export default function HiraganaTablaPage() {
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pb-36 pt-8 sm:px-6 sm:pb-24 sm:pt-10">
        ...
        <motion.div
          ...
          style={{
            ...
            borderColor: "rgba(188,0,45,0.08)",
            boxShadow: "0 18px 40px rgba(64, 41, 66, 0.06)",
            backdropFilter: "blur(10px)",
          }}
        >
          <div
          ...
          >
            Vista reorganizada para leer la tabla completa con mejor equilibrio visual, menos espacio
            vacío y una distribución más cercana a una interfaz web moderna.
          </p>
        </motion.div>
        ...
        <div className="grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_280px]"> 
          <div className="space-y-5">
            <TableSection
              ...
              subtitle="Base principal del silabario, organizada en una cuadrícula más compacta y legible."
              rows={HIRAGANA_TABLE_ROWS}
            ...
            <TableSection
              ...
              subtitle="Variantes con dakuten, manteniendo el mismo patrón visual para facilitar comparación."
              rows={HIRAGANA_DAKUTEN_ROWS}
            ...
            <TableSection
              ...
              subtitle="Bloque compacto para handakuten, con la misma jerarquía visual y espaciado del resto."
              rows={HIRAGANA_HANDAKUTEN_ROWS}
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  <p
                    className="font-mono text-lg font-semibold uppercase tracking-[0.16em]"
                    style={{ color: "var(--sakura-dark)" }}
                  >
                    {selected.romaji}
                  </p>
                ...
                <button
                  ...
                  style={{ border: "1px solid rgba(188,0,45,0.08)", color: "var(--ink-soft)" }}
                >
                  ✕
                </button>
              </div>
