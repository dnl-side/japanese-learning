  ...
  return (
    <main className="relative min-h-screen" style={{ background: "var(--paper)" }}>
      ...
      <div className="relative z-10 flex w-full justify-center">
        <div className="w-full max-w-4xl px-6 pb-24 pt-12">
          ...
          >
            <div
              className="relative mb-4 flex min-h-[160px] items-center justify-center select-none sm:min-h-[190px]"
              aria-hidden="true"
            >
              <span
                className="char-display pointer-events-none absolute inset-0 flex items-center justify-center"
                style={{
            ...
            <p
              className="char-display mt-2 text-center"
              style={{
