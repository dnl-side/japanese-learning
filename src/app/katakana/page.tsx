...
import { KATAKANA_LESSONS, KATAKANA_ALL_CHARS } from "@/data/katakana";
...
const features = [
  ...
  },
  {
    ...
    icon: "◎",
    label: "Trivia",
    desc: "Pon a prueba tu lectura de katakana",
    color: "#FFD580",
    accent: "#8B5E00",
  },
  {
    href: "/katakana/vocabulario",
    icon: "册",
    label: "Vocabulario",
    desc: `${KATAKANA_LESSONS.length} lecciones con palabras extranjeras`,
    color: "#A7F2C4",
    accent: "#1A6B3C",
  },
  {
    href: "/katakana/practica",
    icon: "✏",
...
const PREVIEW_CHARS = ["ア", "イ", "ウ", "エ", "オ", "カ", "キ", "ク", "サ", "シ"];
...
const SURFACE = {
  ...
  border: "1px solid rgba(26,75,192,0.08)",
  boxShadow: "0 20px 42px rgba(45, 60, 110, 0.07)",
...
export default function KatakanaPage() {
  return (
    <main className="relative min-h-screen overflow-hidden" style={{ background: "var(--paper)" }}>
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 pb-20 pt-6 sm:px-6 sm:pb-24 sm:pt-8">
        <motion.div
        ...
        >
          <div className="flex flex-col items-center text-center">
            <div
              ...
              style={{
                color: "#1A4BC0",
                background: "rgba(167,196,242,0.10)",
                border: "1px solid rgba(26,75,192,0.08)",
              }}
            >
              カタカナ · guía inicial
            ...
            <div className="relative mt-6 flex h-[220px] w-full max-w-[520px] items-center justify-center overflow-hidden rounded-[30px] px-4">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at top left, rgba(167,196,242,0.14), transparent 36%), radial-gradient(circle at bottom right, rgba(26,75,192,0.10), transparent 28%)",
                  border: "1px solid rgba(26,75,192,0.06)",
                }}
              />
              ...
              <span
                ...
                style={{
                  ...
                  fontWeight: 700,
                  lineHeight: 1,
                  textShadow: "0 10px 28px rgba(26,75,192,0.10)",
                }}
              >
              </span>
            </div>
            ...
            >
              El katakana se usa principalmente para escribir palabras de origen extranjero,
              nombres propios internacionales y onomatopeyas. Es fundamental para leer menús,
              tecnología y cultura pop japonesa.
            </p>

            <div className="mt-7 grid w-full max-w-3xl grid-cols-1 gap-3 sm:grid-cols-3">
              {[
                { label: "Caracteres básicos", value: `${KATAKANA_ALL_CHARS.length}` },
                { label: "Lecciones", value: `${KATAKANA_LESSONS.length}` },
                ...
                >
                  <div className="text-2xl font-bold leading-none" style={{ color: "#1A4BC0" }}>
                    {stat.value}
                  </div>
                  <div
            ...
            <div className="mt-7 flex w-full max-w-xl flex-col gap-3 sm:flex-row">
              <Link
                ...
                style={{
                  background: "linear-gradient(135deg, #7EA8F6 0%, #1A4BC0 100%)",
                  boxShadow: "0 16px 30px rgba(26, 75, 192, 0.22)",
                }}
              >
                Ver tabla completa
              </Link>
        ...
        <section className="mt-6 rounded-[28px] p-5 sm:p-6" style={SURFACE}>
          <SectionHeader
            ...
            desc="Accede directamente a práctica desde los primeros katakana más comunes, con una franja limpia y fácil de recorrer."
            action={
              <Link
                href="/katakana/tabla"
          ...
          <div className="overflow-x-auto pb-1">
            <div className="flex min-w-max gap-3">
              {PREVIEW_CHARS.map((char, i) => (
                ...
                >
                  <Link
                    href={`/katakana/practica/${encodeURIComponent(char)}`}
                    ...
                    style={{
                      ...
                      borderColor: "rgba(26,75,192,0.08)",
                      boxShadow: "0 12px 24px rgba(45, 60, 110, 0.05)",
                    }}
              ...
              <motion.div custom={PREVIEW_CHARS.length} initial="hidden" animate="show" variants={fadeUp}>
                <Link
                  ...
                  style={{
                    background: "rgba(167,196,242,0.12)",
                    border: "1px dashed rgba(167,196,242,0.75)",
                    color: "#1A4BC0",
                  }}
                >
                  Ver
        ...
        <section className="mt-6">
          <SectionHeader
            ...
            desc="Cada bloque mantiene el mismo ritmo visual de la versión 2, adaptado a katakana con una acentuación azul más limpia."
          />
        ...
        <section className="mt-6 rounded-[28px] p-5 sm:p-6" style={SURFACE}>
          <SectionHeader
            ...
            desc="Organizadas en tarjetas uniformes, con el mismo espaciado cómodo y jerarquía visual clara de la versión 2."
          />

          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            {KATAKANA_LESSONS.map((lesson) => (
              <Link
                key={lesson.id}
                href={`/katakana/vocabulario?leccion=${lesson.id}`}
              ...
              >
                <div className="flex items-start gap-3">
                  <div
                    ...
                    style={{
                      background: "rgba(167,196,242,0.18)",
                      color: "#1A4BC0",
                    }}
                  >
                    {lesson.id.split("-")[1]}
